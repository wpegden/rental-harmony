...
- [ ] Use the new prefix-face transport theorem together with the actual Section 5 forbidden
  convex-hull families to choose milestone points level-by-level, then assemble them into a
