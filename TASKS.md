...
- [ ] Transport the new smaller-simplex convex-hull avoidance theorem back through
  `PrefixFace.equivRentDivision`, then use those avoided points to construct a milestone chain
  satisfying `Section5GraphNode.MilestoneSegmentTransversality`.
